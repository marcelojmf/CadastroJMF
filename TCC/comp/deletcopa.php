...
include("../conect.php");
    if(isset($_GET["id"])){ //se existe esse parametro na url
        ...
        $deletar = "DELETE FROM copinha WHERE id=:id"; // query sql deletar id especifico
        try{
            ...
            if($contarDelete > 0){
                header("Location: ../adm/copinhaADM.php"); //comando de redirecionamento de pagina
            }else{
                header("Location: ../adm/copinhaADM.php");
            }
